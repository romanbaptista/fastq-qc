...
# Manually check preflight_env
file_check_exists "${PREFLIGHT_DIR}/preflight_env.sh" || fail_message "preflight_env.sh doesn't exist"
file_check_nonempty "${PREFLIGHT_DIR}/preflight_env.sh" || fail_message "preflight_env.sh is empty"
